...
public class Masters extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7430911858122279140L;
	...
	public Masters() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//volver a la ventana anterior. Es posible que tengamos que pasar una referencia
				//de la ventana anterior a esta ventana para poder volver a ella. //TODOs
			}
		});
