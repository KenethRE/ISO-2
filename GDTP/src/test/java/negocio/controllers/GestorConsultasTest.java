...
public class GestorConsultasTest {
	...
	public void testConsultarEstadoCursos() {
		assertTrue("la lista devuelta por el metodo consultar Estado Cursos",gestorConsultas.consultarEstadoCursos(EstadoCurso.EN_MATRICULACION,fechacomienzoDate, fechafinDate).isEmpty());
