...
public class GestorConsultasTest {
	...
	public void testConsultarEstadoCursos() {
		assertTrue("la lista devuelta por el metodo consultar Estado Cursos esta vacia",gestorConsultas.consultarEstadoCursos(EstadoCurso.EN_MATRICULACION,fechacomienzoDate, fechafinDate).isEmpty());
...
//		assertFalse("la lista devuelta por el metodo listarEdicionesCursos no esta vacia",gestorConsultas.listarEdicionesCursos(fechacomienzoDate, fechafinDate).isEmpty());
		//fail("Not yet implemented");
	}
